...
export const devtools = {
  overlays: {
    ...
    selectors: [
      ...
      'single-spa-application:@zuehlke/pizza-shop-catalog',
      '.pizza-shop-catalog',
    ],
    // options is optional
    options: {
      ...
      background: 'red', // the default for this is actually based on the app's name, so it's dynamic. can be a hex or a CSS color name
      textBlocks: [
